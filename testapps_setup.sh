...
git clone https://github.com/?/testapps.git

# Configuring testapps
sudo sed -ie 's/$CHAIN_NAME =.*;/$CHAIN_NAME = "'$chainname'";/g' $webserver_activeDirectory/testapps/config.php
sudo sed -ie 's/RPC_USER =.*;/RPC_USER = "'$rpcuser'";/g' $webserver_activeDirectory/testapps/config.php
sudo sed -ie 's/RPC_PASSWORD =.*;/RPC_PASSWORD = "'$rpcpassword'";/g' $webserver_activeDirectory/testapps/config.php
sudo sed -ie 's/RPC_PORT =.*;/RPC_PORT = "'$rpcport'";/g' $webserver_activeDirectory/testapps/config.php
sudo sed -ie 's/MANAGER_ADDRESS =.*;/MANAGER_ADDRESS = "'$addr'";/g' $webserver_activeDirectory/testapps/config.php
